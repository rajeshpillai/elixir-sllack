defmodule SllackWeb.ChatRoomLiveOld do
  ...
  def handle_event("join-room", _, socket) do
    ...
    socket = assign(socket, joined?: true, rooms: Chat.list_joined_rooms_with_unread_counts(current_user))
    {:noreply, socket}
  ...
  defp message(assigns) do
    ...
    <div id={@dom_id} class="group relative flex px-4 py-3">
      ...
      <img class="h-10 w-10 rounded shrink-0" src={~p"/images/avatar.png"} alt="User avatar" />
      <div class="ml-2">
        <div class="-mt-1">
